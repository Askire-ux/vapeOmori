if shared.YokaiExecuted then
	local VERSION = "2.31"..(shared.YokaiPrivate and " PRIVATE" or "")
	...
	local api = {
		...
		["RainbowSpeed"] = 0.6,
		["Language"] = betterisfile("yokai/language.dat") and readfile("yokai/language.dat") or "en-us",
	...
	local translations = {}--loadstring(GetURL("translations/"..api["Language"]..".yokaitranslation") or GetURL("translations/en-us.yokaitranslation"))()
	--local translatedlogo, res = pcall(function() return GetURL("translations/"..api["Language"].."/YokaiLogo1.png") end)
	...
	coroutine.resume(coroutine.create(function()
		...
		until not shared.YokaiExecuted
	end))
	...
	searchbaricon.Image = getcustomassetfunc("yokai/assets/SearchBarIcon.png")
	...
	searchbarshadow.Image = getcustomassetfunc("yokai/assets/WindowBlur.png")
	...
	hoverboxshadow.Image = getcustomassetfunc("yokai/assets/WindowBlur.png")
	...
	api["SaveSettings"] = function()
		if loadedsuccessfully then
			writefile(customdir.."Profiles/"..(shared.CustomSaveYokai or game.PlaceId)..".yokaiprofiles.txt", game:GetService("HttpService"):JSONEncode(api["Profiles"]))
			local WindowTable = {}
			...
			writefile(customdir.."Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveYokai or game.PlaceId)..".yokaiprofile.txt", game:GetService("HttpService"):JSONEncode(api["Settings"]))
			writefile(customdir.."Profiles/"..(game.GameId).."GUIPositions.yokaiprofile.txt", game:GetService("HttpService"):JSONEncode(WindowTable))
		end
	end
	...
	api["LoadSettings"] = function(customprofile)
		if identifyexecutor and identifyexecutor():find("ScriptWare") == nil and listfiles then
			for i,v in pairs(listfiles(customdir.."Profiles")) do 
				...
				if (ext and ext:find("yokaiprofile") and ext:find("txt") == nil) then
		...
		if betterisfile("yokai/Profiles/GUIPositions.yokaiprofile.txt") and game.GameId == 2619619496 then
			writefile("yokai/Profiles/"..(game.GameId).."GUIPositions.yokaiprofile.txt", readfile("yokai/Profiles/GUIPositions.yokaiprofile.txt"))
			if delfile then delfile("yokai/Profiles/GUIPositions.yokaiprofile.txt") end
		end
		if shared.YokaiPrivate then
			if betterisfile("yokaiprivate/Profiles/"..(game.GameId).."GUIPositions.yokaiprofile.txt") == false and betterisfile("yokai/Profiles/"..(game.GameId).."GUIPositions.yokaiprofile.txt") then
				writefile("yokaiprivate/Profiles/"..(game.GameId).."GUIPositions.yokaiprofile.txt", readfile("yokai/Profiles/"..(game.GameId).."GUIPositions.yokaiprofile.txt"))
			end
			if betterisfile("yokaiprivate/Profiles/"..(shared.CustomSaveYokai or game.PlaceId)..".yokaiprofiles.txt") == false and betterisfile("yokai/Profiles/"..(shared.CustomSaveYokai or game.PlaceId)..".yokaiprofiles.txt") then
				writefile("yokaiprivate/Profiles/"..(shared.CustomSaveYokai or game.PlaceId)..".yokaiprofiles.txt", readfile("yokai/Profiles/"..(shared.CustomSaveYokai or game.PlaceId)..".yokaiprofiles.txt"))
			end
			if betterisfile("yokaiprivate/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveYokai or game.PlaceId)..".yokaiprofile.txt") == false and betterisfile("yokai/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveYokai or game.PlaceId)..".yokaiprofile.txt") then
				writefile("yokaiprivate/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveYokai or game.PlaceId)..".yokaiprofile.txt", readfile("yokai/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveYokai or game.PlaceId)..".yokaiprofile.txt"))
			end
		end
		local success2, result2 = pcall(function()
			return game:GetService("HttpService"):JSONDecode(readfile(customdir.."Profiles/"..(shared.CustomSaveYokai or game.PlaceId)..".yokaiprofiles.txt"))
		end)
		...
		local success3, result3 = pcall(function()
			return game:GetService("HttpService"):JSONDecode(readfile(customdir.."Profiles/"..(game.GameId).."GUIPositions.yokaiprofile.txt"))
		end)
		...
		local success, result = pcall(function()
			return game:GetService("HttpService"):JSONDecode(readfile(customdir.."Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveYokai or game.PlaceId)..".yokaiprofile.txt"))
		end)
	...
	api["SwitchProfile"] = function(profilename)
		...
		if (not betterisfile(customdir.."Profiles/"..(profilename == "default" and "" or profilename)..(shared.CustomSaveYokai or game.PlaceId)..".yokaiprofile.txt")) then
		...
		local oldindependent = shared.YokaiIndependent
		api["SelfDestruct"]()
		if not oldindependent then
			shared.YokaiSwitchServers = true
			shared.YokaiOpenGui = (clickgui.Visible)
	...
	api["CreateMainWindow"] = function()
		...
		windowshadow.Image = getcustomassetfunc("yokai/assets/WindowBlur.png")
		...
		windowlogo1.Image = getcustomassetfunc(translatedlogo and "yokai/translations/"..api["Language"].."/YokaiLogo1.png" or "yokai/assets/YokaiLogo1.png")
		...
		windowlogo2.Image = getcustomassetfunc("yokai/assets/YokaiLogo2.png")
		...
		settingsbox2.Text = "Yokai "..VERSION.."  "
		...
		settingswheel.Image = getcustomassetfunc("yokai/assets/SettingsWheel1.png")
		...
		discordbutton.Image = getcustomassetfunc("yokai/assets/DiscordIcon.png")
		...
		discordbutton.MouseButton1Click:Connect(function()
			...
			spawn(function()
				...
				setclipboard("https://discord.com/invite/FqE9Qjb5mn")
				wait(1)
				hoverbox3:Remove()
			end)
		end)
		...
		settingsexit.Image = getcustomassetfunc("yokai/assets/ExitIcon1.png")
		...
		overlaysicon.Image = getcustomassetfunc("yokai/assets/TextGUIIcon4.png")
		...
		overlaysexit.Image = getcustomassetfunc("yokai/assets/ExitIcon1.png")
		...
		overlaysbutton.Image = getcustomassetfunc("yokai/assets/TextGUIIcon2.png")
		...
		windowbackbutton.Image = getcustomassetfunc("yokai/assets/BackIcon.png")
		...
		windowapi["CreateCustomToggle"] = function(argstable)
			...
			api["ObjectsThatCanBeSaved"]["YokaiSettings"..argstable["Name"].."Toggle"] = {["Type"] = "Toggle", ["Object"] = buttontext, ["Api"] = buttonapi}
			return buttonapi
		end
		...
		windowapi["CreateDivider2"] = function(text)
			...
			if text then
				...
				arrow.Image = getcustomassetfunc("yokai/assets/RightArrow.png")
				arrow.Active = false
				arrow.Parent = button
				...
				windowbackbutton2.Image = getcustomassetfunc("yokai/assets/BackIcon.png")
				...
				windowapi3["CreateToggle"] = function(argstable)
					...
					buttonarrow.Image = getcustomassetfunc("yokai/assets/ToggleArrow.png")
				...
				windowapi3["CreateSlider"] = function(argstable)
					...
					slider3.Image = getcustomassetfunc("yokai/assets/SliderButton1.png")
		...
		windowapi["CreateGUIBind"] = function()
			...
			bindtext2.Image = getcustomassetfunc("yokai/assets/BindBackground.png")
		...
		windowapi["CreateColorSlider"] = function(name, temporaryfunction)
			...
			sliderrainbow.Image = getcustomassetfunc("yokai/assets/RainbowIcon1.png")
			...
			slider3.BorderSizePixel = 0
			slider3.ZIndex = 2
			slider3.Image = getcustomassetfunc("yokai/assets/ColorSlider1.png")
			...
			sliderapi["SetValue"] = function(hue, sat, val)
				...
				sat = sat or 0.7
				val = val or 0.9
				slider3.Image = (sliderapi["RainbowValue"] and getcustomassetfunc("yokai/assets/ColorSlider2.png") or getcustomassetfunc("yokai/assets/ColorSlider1.png"))
				sliderrainbow.Image = (sliderapi["RainbowValue"] and getcustomassetfunc("yokai/assets/RainbowIcon2.png") or getcustomassetfunc("yokai/assets/RainbowIcon1.png"))
			...
			sliderapi["SetRainbow"] = function(val)
				...
				if sliderapi["RainbowValue"] then
					...
					heh = coroutine.resume(coroutine.create(function()
						...
						until sliderapi["RainbowValue"] == false or shared.YokaiExecuted == nil
					end))
				end
			end
	...
	api["CreateCustomWindow"] = function(argstablemain)
		...
		expandbutton.Image = getcustomassetfunc("yokai/assets/PinButton.png")
		...
		optionsbutton.Image = getcustomassetfunc("yokai/assets/MoreButton3.png")
		...
		windowapi["CreateCircleWindow"] = function(argstablemain3)
			...
			targeticon.Image = getcustomassetfunc("yokai/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			targeticon.ZIndex = 2
			...
			windowicon.Image = getcustomassetfunc("yokai/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			...
			windowapi3["CreateCircleTextList"] = function(argstable)
				...
				textboxbkg.Image = getcustomassetfunc((argstable["Name"] == "ProfilesList" and "yokai/assets/TextBoxBKG2.png" or "yokai/assets/TextBoxBKG.png"))
				...
				addbutton.Image = getcustomassetfunc("yokai/assets/AddItem.png")
				...
				textapi["RefreshValues"] = function(tab, tab2)
					...
					for i,v in pairs(textapi["ObjectList"]) do
						...
						deletebutton.Image = getcustomassetfunc("yokai/assets/AddRemoveIcon1.png")
		...
		windowapi["CreateDropdown"] = function(argstable)
			...
			expandbutton2.Image = getcustomassetfunc("yokai/assets/DownArrow.png")
			...
			drop2.ExpandButton2.Image = getcustomassetfunc("yokai/assets/UpArrow.png")
			local thing = Instance.new("Frame")
			thing.Size = UDim2.new(1, 2, 1, 2)
			thing.BorderSizePixel = 0
			thing.Position = UDim2.new(0, -1, 0, -1)
	...
	api["CreateWindow"] = function(argstablemain2)
		...
		expandbutton2.Active = false
		expandbutton2.Size = UDim2.new(0, 9, 0, 4)
		expandbutton2.Image = getcustomassetfunc("yokai/assets/UpArrow.png")
		...
		windowapi["CreateOptionsButton"] = function(argstablemain)
			...
			button2.Image = getcustomassetfunc("yokai/assets/MoreButton1.png")
		...
		--	children2.LayoutOrder = amount
			...
			buttonapi["ToggleButton"] = function(clicked, toggle)
				...
				if buttonapi["Enabled"] then
					...
					button2.Image = getcustomassetfunc("yokai/assets/MoreButton2.png")
			...
			buttonapi["CreateTextList"] = function(argstable)
				...
				textboxbkg.Position = UDim2.new(0, 10, 0, 5)
				textboxbkg.ClipsDescendants = true
				textboxbkg.Image = getcustomassetfunc("yokai/assets/TextBoxBKG.png")
				textboxbkg.Parent = frame
				local textbox = Instance.new("TextBox")
				textbox.Size = UDim2.new(0, 159, 1, 0)
				textbox.Position = UDim2.new(0, 11, 0, 0)
			...
			buttonapi["CreateTargetWindow"] = function(argstablemain3)
				...
				local windowicon = Instance.new("ImageLabel")
				windowicon.Size = UDim2.new(0, 18, 0, 16)
				windowicon.Image = getcustomassetfunc("yokai/assets/TargetIcon.png")
				windowicon.ImageColor3 = Color3.fromRGB(200, 200, 200)
				windowicon.ZIndex = 3
				windowicon.Name = "WindowIcon"
				windowicon.BackgroundTransparency = 1
				...
				buttonreturned["Players"] = windowapi["CreateButton"]({
					...
					["Icon"] = "yokai/assets/TargetIcon1.png",
					["IconSize"] = 15,
				...
				buttonreturned["NPCs"] = windowapi["CreateButton"]({
					...
					["Icon"] = "yokai/assets/TargetIcon2.png",
					["IconSize"] = 12,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Peaceful"] = windowapi["CreateButton"]({
					...
					["Icon"] = "yokai/assets/TargetIcon3.png",
					["IconSize"] = 16,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Neutral"] = windowapi["CreateButton"]({
					...
					["Icon"] = "yokai/assets/TargetIcon4.png",
					["IconSize"] = 19,
					["Function"] = function() end,
					["Default"] = false
				})
			...
			buttonapi["CreateColorSlider"] = function(argstable)
				...
				sliderexpand.Image = getcustomassetfunc("yokai/assets/HoverArrow3.png")
				sliderexpand.Parent = frame
				sliderexpand.MouseEnter:Connect(function()
					sliderexpand.Image = getcustomassetfunc("yokai/assets/HoverArrow4.png")
				end)
			...
			buttonapi["CreateTwoSlider"] = function(argstable)
				...
				text4.Image = getcustomassetfunc("yokai/assets/SliderArrowSeperator.png")
				...
				slider3.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
				slider3.BorderSizePixel = 0
				slider3.Image = getcustomassetfunc("yokai/assets/SliderArrow1.png")
	...
	api["CreateWindow2"] = function(argstablemain)
		...
		settingsbutton.Image = getcustomassetfunc("yokai/assets/SettingsWheel2.png")
		...
		windowapi["CreateColorSlider"] = function(argstable)
			...
			sliderexpand.BackgroundTransparency = 1
			sliderexpand.Position = UDim2.new(0, game:GetService("TextService"):GetTextSize(text1.Text, text1.TextSize, text1.Font, Vector2.new(10000, 100000)).X + 3, 0, 6)
			sliderexpand.Image = getcustomassetfunc("yokai/assets/HoverArrow.png")
			sliderexpand.Parent = frame
			sliderexpand.MouseEnter:Connect(function()
				sliderexpand.Image = getcustomassetfunc("yokai/assets/HoverArrow2.png")
			end)
			sliderexpand.MouseLeave:Connect(function()
				sliderexpand.Image = getcustomassetfunc("yokai/assets/HoverArrow.png")
			end)
	...
	api["CreateNotification"] = function(top, bottom, duration, customicon)
		...
		image.Image = getcustomassetfunc("yokai/assets/NotificationBackground.png")
		...
		frame2.ZIndex = 2
		frame2.Image = getcustomassetfunc("yokai/assets/NotificationBar.png")
		frame2.BorderSizePixel = 0
		frame2.Parent = image
		local icon = Instance.new("ImageLabel")
		icon.Name = "IconLabel"
		icon.Image = getcustomassetfunc(customicon and "yokai/"..customicon or "yokai/assets/InfoNotification.png")
