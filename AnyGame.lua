					...
					spawn(function()
						repeat
							if ChatSpammer["Enabled"] then
								pcall(function()
									repstorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer((#ChatSpammerMessages["ObjectList"] > 0 and ChatSpammerMessages["ObjectList"][math.random(1, #ChatSpammerMessages["ObjectList"])] or "mreow meowww meow mreeoooowww"), "All")
								end)
							end
							if waitnum ~= 0 then
								wait(waitnum)
...
runcode(function()
	...
	local reporttable = {
		...
		["disco"] = "Offsite Links",
		["yt"] = "Offsite Links",
		["youtoob"] = "Offsite Links",
		["dizcourde"] = "Offsite Links",
		["disboard"] = "Offsite Links",
		["dizzy"] = "Offsite Links",
		["disc"] = "Offsite Links",
		["retard"] = "Swearing",
		["bad"] = "Bullying",
